...
\(0 = 1\)を仮定して矛盾を導く．
\Cref{item:PAA1}から
\(0 + 1 \neq 1\)である．しかし，\Cref{item:PAA3}から\(0 + 1 = 1\)だが\(0 = 1\)と仮定したので
\(0 + 1 = 0\)であり矛盾である．よって\(0 \neq 1\)となる．
従って，\cref{item:PAA10}により\(1 = y + 1\)となる\(y \in M\)がとれる．
\(y = 0\)であることを示せば\(\symcal{M} \satisfy \numeral{1} \objeq \obj{1}\)が従う．
\Cref{item:PAA4}から
\(0 + 1 = 0 + \paren{y + 1} = \paren{0 + y} + 1\)だから\cref{item:PAA2}より\(0 + y = 0\)である．
そこで，\(y \neq 0\)と仮定すると\cref{item:PAA10}から\(y = z + 1\)となる\(z \in M\)が存在するが，
