...
\begin{Thm} \label[Thm]{Thm:equalsign}
	...
	は導出可能である．すなわち
	\begin{equation}
		s_i = t_i \provable \apply{f}{s_1, s_2, \dotsc, s_i, \dotsc, s_n} = \apply{f}{s_1, s_2, \dotsc, t_i, \dotsc, s_n}
	\end{equation}
	が成り立つ．
\end{Thm}
...
\begin{Thm} \label[Thm]{Thm:equalsignrelation}
	...
	\begin{align}
		s = t \sequent t = s, \label{eq:equalsignsymmetry} \\
		\paren{s = t} \land \paren{t = u} \sequent s = u \label{eq:equalsigntransitivity}
	\end{align}
	は導出可能である．すなわち
	\begin{align}
		s = t \provable t = s, \\
		\paren{s = t} \land \paren{t = u} \provable s = u
	\end{align}
	が成り立つ．
\end{Thm}
