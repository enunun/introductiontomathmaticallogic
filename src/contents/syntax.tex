...
\begin{Ex} \label[Ex]{Ex:Ring}
	...
	\begin{enumerate}
		\item \(\forall \obj{x} \forall \obj{y} \forall \obj{z} \paren{\paren{\obj{x} \obj{+} \obj{y}} \obj{z} \objeq \obj{x} \obj{+} \paren{\obj{y} \obj{+} \obj{z}}},\)
...
\begin{Ex} \label[Ex]{Ex:OrderedRing}
	...
	\begin{enumerate}
		...
		\item \(\forall \obj{x} \forall \obj{y}
		      \paren{\paren{\obj{x} \obj{<} \obj{y} \lor \obj{y} \obj{<} \obj{x}} \lor \obj{x} \objeq \obj{y}},\)
		\item \(\forall \obj{x} \forall \obj{y} \forall \obj{z}
...
\index[sidx]{\(\ProjectiveGeometryPart\)：射影幾何の部分体系}
\index[sidx]{\(\symcal{L}_{\ProjectiveGeometryPart}\)：射影幾何の言語}
\begin{Ex} \label[Ex]{Ex:ProjectiveGeometry}
	\NewDocumentCommand{\LiesOn}{}{\obj{\varepsilon}}
	射影幾何の言語を\(\symcal{L}_{\ProjectiveGeometryPart}\)を\(\symcal{L}_{\ProjectiveGeometryPart} = \Set{\obj{P}, \obj{L}, \LiesOn}\)
	とする．ここで，\(\obj{P}, \obj{L}\)はアリティ1の関係記号，\(\obj{\varepsilon}\)はアリティ2の関係記号である．
	このとき，射影幾何の理論の部分体系\(\ProjectiveGeometryPart\)として，以下の文からなる\(\symcal{L}_{\ProjectiveGeometryPart}\)理論を考えることができる：
	\begin{enumerate}
		...
		\item \(\forall \obj{x} \forall \obj{y} \paren{\apply{\obj{P}}{\obj{x}} \land \apply{\obj{P}}{\obj{y}} \land \lnot \paren{\obj{x} \objeq \obj{y}}
			      \to \uexists z \paren{\obj{x} \LiesOn \obj{x} \land \obj{y} \LiesOn \obj{z}}},\)
		\item \(\forall \obj{x} \forall \obj{y} \paren{\paren{\apply{\obj{L}}{\obj{x}} \land \apply{\obj{L}}{y}} \land \lnot \paren{\obj{x} \objeq \obj{y}}
			      \to \uexists z \paren{\obj{z} \LiesOn \obj{x} \land \obj{z} \LiesOn \obj{y}}},\)
		\item \(\apply{c}{x, y, z}\)を
		      \[\exists \obj{w} \paren{x \LiesOn \obj{w} \land y \LiesOn \obj{w} \land z \LiesOn \obj{w}}
		      \]
		      の略記，
		      \(\apply{n}{a, b, c, d}\)を\[
		      ...
		      の略記として
		      \begin{align*}
			      \exists \obj{a} \exists \obj{b} \exists \obj{c} \exists \obj{d} \paren{\apply{n}{\obj{a}, \obj{b}, \obj{c}, \obj{d}}
				      \land \lnot \apply{c}{\obj{a}, \obj{b}, \obj{c}}
				      \land \lnot \apply{c}{\obj{a}, \obj{b}, \obj{d}}
				      \land \lnot \apply{c}{\obj{a}, \obj{c}, \obj{d}}
				      \land \lnot \apply{c}{\obj{b}, \obj{c}, \obj{d}}
			      }.
		      \end{align*}
	\end{enumerate}
...
\begin{Que} \label[Que]{Que:ProjectiveGeometrydual}
	...
	\(\symcal{L}_{\ProjectiveGeometryPart}\)を\(\tilde{\sigma}\)とする%
	\footnote{%
	...
	\begin{enumerate}
		...
		\item \(\sigma\)にあらわれる\(x \LiesOn y\)を\(y \LiesOn x\)に変更する．
	\end{enumerate}
