...
\(s_i, t_i\)に登場しない，つまり\(\apply{\FV}{s_i}, \apply{\FV}{t_i}, \apply{\BV}{s_i}, \apply{\BV}{t_i}\)のいずれの元でもない変数記号\(x\)をとり，
論理式
\begin{equation*}
...
\begin{enumerate}
	...
	\item \(\sequent s = t \to t = s\)\quad （\Cref{eq:equalsignsymmetry}と(\(\to\)I)による）
