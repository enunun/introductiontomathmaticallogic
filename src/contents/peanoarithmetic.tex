...
\Cref{sec:peanoarithmetic}では，
1階Peano算術やその部分体系について考察した．
本節では，それ以降の議論の準備として帰納的関数について議論する．

帰納的関数の定義や基本性質自体は，1階Peano算術どころか形式体系すら持ち出さずに議論できる対象である．
...
\index[sidx]{\(\mu\)：\(\mu\)演算子}
\index[widx]{\(\mu\)えんざんし@\(\mu\)演算子}
\index[sidx]{\(\zero\)：ゼロ関数}
