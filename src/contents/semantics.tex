...
\begin{Lemma}[存在除去律] \label{lemma:semanticexistselimination}
...
\begin{Lemma}[全称導入律] \label{lemma:semanticforallinsertion}
...
\begin{Lemma}[存在導入律] \label{lemma:semanticexistsinsertion}
	\(\Gamma\)を閉論理式の集合とし，\(x\)を変数記号，\(\varphi\)を論理式とする．
...
\begin{Thm}[De Morganの法則] \label{Thm:semanticDemorganslawproposition}
...
\begin{Thm} \label{Thm:semanticforallexiststo}
	\(\varphi, \psi\)を論理式，\(x\)を変数記号とする．
	このとき
	\begin{align}
...
\begin{Thm} \label{Thm:semanticforallexistslandlor}
	\(\varphi, \psi\)を論理式，\(x\)を変数記号とする．
	このとき
	\begin{align}
...
\begin{Thm} \label{Thm:semanticforallexistslandloroneside}
	\(\varphi, \psi\)を論理式，\(x\)を変数記号とする．
	このとき
	\begin{align}
