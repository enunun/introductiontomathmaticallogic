...
\begin{Ex} \label[Ex]{Ex:ProjectiveGeometry}
	...
	\begin{enumerate}
		...
		\item \(\apply{C}{x, y, z}\)を
		      \[
			      \lnot \exists \obj{w} \paren{\paren{x \LiesOn \obj{w} \land y \LiesOn \obj{w}} \land z \LiesOn \obj{w}}
		      \]
		      の略記，
		      \(\apply{n}{a, b, c, d}\)を\[
			      \paren{\paren{\paren{\lnot \paren{a \objeq b} \land \lnot \paren{a \objeq c}} \land \lnot \paren{a \objeq d}} \land \lnot \paren{b \objeq c}}
