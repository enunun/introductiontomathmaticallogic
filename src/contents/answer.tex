...
\(t\)が変数記号か定数記号である場合には，別の変数記号\(y\)をとって論理式\(\apply{\theta}{y}\)を\(y \objeq t\)と定めればよい．
...
\[
	\apply{\hat{\theta}}{x_1,x_2,\dots,x_n, \apply{f}{x_1,x_2,\dots,x_n}}
\]
とする．
...
よってシークエント
\[
	\sequent \varphi_1 \to \paren{\varphi_2 \to \paren{\dotsb \to \varphi_n}}
\]
は導出可能である．
各\(i = 1,2,\dots,n\)に対してシークエント\(\Sigma \sequent \varphi_i\)は導出可能だから，
(\(\to\)E)規則を繰り返し適用することで\(\Sigma \provable \varphi\)であることがわかる．
