...
体系の内容としては計算機科学における型システムに近い．
例えば，古典ではあるがいわゆるTaPL\cite{pierce2013types_jp}を見れば，おおよそ同じような体系が紹介されている．
...
\index[sidx]{\(\obj{s}\)：体系\(\symcal{R}\)における関数記号}
\index[sidx]{\(\evaluate\)：体系\(\symcal{R}\)における関係記号}
\begin{table}[htbp]
	\centering
